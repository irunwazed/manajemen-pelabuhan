      ...
      <div class="text-center mb-3 mt-5">
        ...
        <form action="" method="get">
          <div class="flex flex-wrap place-content-center my-2">
            ...
            <a href="{{url('/'.$user.'/eksport-import/header')}}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-10 py-2.5 ml-1 mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">DOKUMEN BARU</a> 
        </div>
        </form>
      </div>
