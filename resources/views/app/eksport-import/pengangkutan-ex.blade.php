...
@section('content')
        ...
        <div class="text-2xl ">Eksport-Import / Pembuatan Dokumen PEB</div>
            ...
            <nav>
                <ul class="menu flex">
                    ...
                    <li style="padding-left: 10px; padding-right: 10px; color: green;"><a href="{{url('admin/eksport-import/pengangkutan-ex')}}">DATA PENGANGKUTAN</a></li>
    ...
    <div class="h-56 grid grid-cols-1">
        <table class="mt-5 w-full border-solid border-2 border-slate-800">
            ...
            <tbody>
                <?php
                foreach ($data_pengangkut_sarana_peb as $key => $value) {
                    echo'
                    <tr class="border-solid border-2 border-slate-800 hover:bg-slate-300">
                        <td>'.$value->no_seri.'</td>
                        <td>'.$value->no_pengangkut.'</td>
                        <td>'.$value->nama_pengangkut.'</td>
                        <td>'.$value->bendera.'</td>
                    </tr>
                    ';
                }
