        ...
        <div>
            <table class="w-full">
                ...
                <tr class="text-start">
                    ...
                    <td>:</td>
                    <td class="py-1">
                        <select id="pbm" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option value="PBM1">PBM A</option>
                            <option value="PBM2">PBM B</option>
                        </select>
                    </td>
                </tr>
                <tr class="text-start">
        ...
        <div>
            <table class="w-full">
                ...
                <tr class="text-start">
                    ...
                    <td>:</td>
                    <td class="py-1">
                        <select id="kegiatan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <tr class="text-start">
                    ...
                    <td>:</td>
                    <td class="py-1">
                        <select id="posisi" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <option value="posisi1">Utara</option>
                                <option value="posisi2">Selatan</option>
                                <option value="posisi3">Timur</option>
                                <option value="posisi4">Barat</option>
                        </select>
                    </td>
                </tr>
                <tr class="text-start">
                ...
                <tr class="text-start mb-4">
                    ...
                    <td class="py-1">
                        <select id="barang" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option value="lokasi1">Lokasi Galangan</option>
                            <option value="lokasi2">Pelabuhan</option>
                        </select>
                    </td>
                </tr>
                <tr class="text-start mb-4">
