                ...
                <table class="mt-5 w-full border-solid border-2 border-slate-800">
                    ...
                    <tbody>
                        ...
                        <td class="py-2 flex flex-wrap gap-1 justify-center ">
                            <a href="{{url('admin/warehousing/create-penerimaan-barang')}}" class="focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">View</a>
                            <a href="{{url('admin/warehousing/edit-penerimaan-barang')}}" class="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:focus:ring-yellow-900">Edit</a>
                            <a href="{{url('admin/warehousing/delete-penerimaan-barang')}}" class="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:focus:ring-yellow-900">Delete</a>
                        </td>
                        </tr>
                    </tbody>
                </table>
