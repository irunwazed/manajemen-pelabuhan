...
@section('content')
    ...
    <div class="">
        <div class="text-2xl ">Pembayaran Tagihan {{$pembayaran->no_pembayaran}}</div>
                ...
                <div>
                    <table class="w-full">
                        <tr>
                            <td>No Pembayaran</td>
                            <td>:</td>
                            <td><input type="text"  class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ @$pembayaran->no_pembayaran }}" disabled></td>
                        </tr>
                        <tr>
                            <td>Kode Rekening</td>
                            <td>:</td>
                            <td><input type="text"  class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ @$pembayaran->kode_rekening_kas }}" disabled></td>
                        </tr>
                        <tr>
                            <td>Nama Rekening</td>
                            <td>:</td>
                            <td><input type="text"  class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ @$pembayaran->nama_rekening_kas }}" disabled></td>
                        </tr>
                    </table>
                </div>
                <div>
                    <table class="w-full">
                        <tr>
                            <td>Tanggal</td>
                            <td>:</td>
                            <td><input type="text"  class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ @$pembayaran->tanggal }}" disabled></td>
                        </tr>
                        <tr>
                            <td>Jumlah</td>
                            <td>:</td>
                            <td><input type="text"  class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ @$pembayaran->jumlah }}" disabled></td>
                        </tr>
                    </table>
                </div>
            </div>
                ...
                <table class="mt-5 w-full border-solid border-2 border-slate-800">
                    ...
                    @foreach($details as $index => $item)
                        <tr class="border-solid border-2 border-slate-800 hover:bg-slate-300">
                            ...
                            <td class="py-2.5">{{ $item->kode_rekening_pengeluaran }}</td>
                            <td class="py-2.5">{{ $item->nama_rekening_pengeluaran }}</td>
