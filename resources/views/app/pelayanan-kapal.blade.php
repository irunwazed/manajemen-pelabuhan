...
<div class="px-3 mb-20">
  ...
  <div class="mt-8 grid grid-cols-3 gap-6">
    ...
    <a href="{{ url('').$navigation['url'] }}" class="py-10 px-20 text-center border-solid border-black border-2 rounded-lg shadow-lg hover:cursor-pointer hover:border-0 hover:shadow-2xl hover:bg-slate-50">
      {{ $navigation['name'] }}
    </a>
    @endforeach
  </div>
