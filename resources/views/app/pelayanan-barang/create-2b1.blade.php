    ...
    <div class="">
        ...
        <form class="text-center mb-3 mt-5" action="{{ route('create-2B1', $user) }}" method="post" id="create-2b1">
            ...
            <div class="text-start mt-3">
                <a onclick="document.getElementById('form-2b1').submit();"
                    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-10 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">SIMPAN</a>
