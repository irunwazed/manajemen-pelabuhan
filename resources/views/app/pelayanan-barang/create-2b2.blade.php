    ...
    <div class="">
        ...
        <div class="text-center mb-3 mt-5">
            ...
            <div class="text-start">
                ...
                <a href="{{url('admin/pelayanan-barang/pengeluaran-2b2')}}" class="font-semibold py-1 px-6 rounded-md hover:opacity-80 mt-6 bg-warning text-blue-100 hover:bg-purple-600">Kembali</a>
            </div>
        </div>
    </div>
@endsection
