                ...
                <table class="mt-5 w-full border-solid border-2 border-slate-800">
                    ...
                    <tr class="border-solid border-2 border-slate-800 hover:bg-slate-300">
                        ...
                        <td class="py-2 flex flex-wrap gap-1 justify-center ">
                            ...
                            <a href="{{url('admin/pelayanan-barang/create-nota-4B')}}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Create Nota 4B</a>
                        </td>
                    </tr>
                    </tbody>
                </table>
