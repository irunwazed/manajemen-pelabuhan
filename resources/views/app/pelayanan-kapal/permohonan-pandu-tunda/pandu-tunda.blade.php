...
<div class="">
  ...
  <div class="text-2xl ">Pelayanan Kapal / Pandu dan Tunda</div>
  <hr class="border-b-2 border-black border-solid">

  <div class="text-center mb-3 mt-5">
    <h2 class="text-2xl font-bold mt-10 mb-7">PERMOHONAN PANDU DAN TUNDA</h2>
    <center>
      ...
      @foreach($data as $row)
          ...
          <tr class="border-solid border-1 border-slate-800 bg-slate-200 hover:bg-slate-300">
            ...
            <td class="py-3">
              ...
              @endif
              <a href="{{ url('/admin/pelayanan-kapal/pandu-tunda/pandu-tunda-edit/'.$row->pelayanan_kapal_rpkro_id)  }}" class="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-yellow-900">Edit</a>
              <a href="{{ url('/admin/pelayanan-kapal/pandu-tunda/pandu-tunda-view/'.$row->pelayanan_kapal_rpkro_id)  }}" class="focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">View</a>
