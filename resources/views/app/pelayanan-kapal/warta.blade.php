...
<div class="">
  ...
  <div class="text-center mb-3 mt-5">
    ...
    <div class="place-content-center flex mt-5">
      <form action="/{{ $user }}/pelayanan-kapal/pengajuan-pkk" method="get">
        ...
        <div>
          <button class="mr-3 py-2 px-5 bg-cyan-800 text-white font-semibold rounded-xl shadow-xl hover:opacity-70" type="submit">AJUKAN PKK</button>
        </div>
      </form>
