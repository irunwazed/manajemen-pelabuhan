...
<div class="">
  ...
  <div class=" mb-3 mt-5">
    ...
    <div class="flex flex-wrap place-content-end my-2">
      ...
      <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-10 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" onclick="save()">SIMPAN</button>
      ...
      <div>
        ...
        <table class="w-full">
          <tr>
            <td>NAMA</td>
            <td>:</td>
            <td><input type="text" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ @$data->perusahaan_pemilik_kapal }}" name="perusahaan_pemilik_kapal" disabled></td>
          </tr>
          <tr>
            <td>PENANGGUNG JAWAB</td>
            <td>:</td>
            <td><input type="text" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ @$data->penanggung_jawab }}" name="penanggung_jawab" disabled></td>
          </tr>
          <tr>
            <td>SIUPAL PEMILIK</td>
            <td>:</td>
            <td><input type="text" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ @$data->siupal_pemilik }}" name="siupal_pemilik" disabled></td>
          </tr>
          <tr>
            <td>ALAMAT</td>
            <td>:</td>
            <td><input type="text" disabled class="w-full py-10 bg-gray-100 rounded-2xl px-3 border-gray-300 mr-3" value="{{ @$data->alamat }}" name="alamat" /></td>
          </tr>
          <tr>
            <td colspan="3" class="h-6"></td>
          </tr>
          ...
          <tr>
            <td>PENANGGUNG JAWAB</td>
            <td>:</td>
            <td><input type="text" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ @$data->penanggung_jawab_agen }}" name="penanggung_jawab_agen" disabled></td>
          </tr>
          <tr>
          ...
          <tr>
            <td>ALAMAT</td>
            <td>:</td>
            <td><input type="text" disabled class="w-full py-10 bg-gray-100 rounded-2xl px-3 border-gray-300 mr-3" value="{{ @$data->alamat_agen }}" name="alamat_agen" /></td>
          </tr>
          <tr>
            <td colspan="3" class="h-6"></td>
          </tr>
                ...
                <form action="./pengajuan-pkk/crew-list/import" method="post" enctype="multipart/form-data">
                  ...
                  <div class="p-6 space-y-6">
                    ...
                    <div class="flex-nowrap">
                      ...
                      <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" name="files" type="file">
                    </div>
                  </div>
                  <!-- Modal footer -->
                  <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                      ...
                      <form action="./pengajuan-pkk/kontainer/import" method="post" enctype="multipart/form-data">
                        ...
                        <div class="p-6 space-y-6">
                          ...
                          <div class="flex-nowrap">
                            ...
                            <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" type="file" name="files">
                          </div>
                        </div>
                        <!-- Modal footer -->
                        <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      ...
                      <option value="{{ @$rowPelabuhan->id }}">{{ @$rowPelabuhan->nama_pelabuhan }}</option>
                      @endforeach
                    </select>
                  </td>
                  </tr>
                  <tr>
                    <td class="text-center">2</td>
                    <td>WAKTU TIBA</td>
                    <td><input type="date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></td>
                  </tr>
                  <tr>
                    <td class="text-center">3</td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <option value="{{ @$rowDermaga->lokasi_dermaga_id  }}">{{ @$rowDermaga->nama_dermaga }}</option>
                      @endforeach
                    </select>
                  </td>
                  </tr>
...
<script>
  ...
  function save() {
    ...
    data['alamat_agen'] = $('input[name="alamat_agen"]').val();
    ...
    data['pelabuhan_tujuan'] = $('input[name="pelabuhan_tujuan"]').val();
  ...
  function getDermagaByPelabuhan(pelabuhan){
    $.when(sendAjax('{{ URL::to("") }}/api/get/Pelabuhan/'+pelabuhan+'/dermaga', data, 'get')).done(function(res) {
      if (res.status) {
        ...
        for(let i = 0; i < res.data.length; i++){
          $('select[name="permintaan_lokasi_tambat"]').append('<option>'+res.data[i].+'</option>');
        }
      } else {
        pesanSweet('Gagal!', res.message, 'warning');
      }
  ...
  //       // $('#modal-pmb').removeClass("flex")
  //       // $('#modal-pmb').addClass("hidden")
  //       pesanSweet('Berhasil', res.messagege);
  //       loadPBM()
  //       // setTimeout(function(){
  //       //   window.location.reload(1);
  //       // }, 2000);
