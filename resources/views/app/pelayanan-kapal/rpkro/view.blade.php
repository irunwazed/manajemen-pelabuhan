        ...
        <div class="w-[900px]">
          <div class=" my-2 grid grid-cols-3 gap-3">
            <div class="mb-1 text-left">
              ...
              <input type="text" name="no_rpkro" disabled value="{{ @$input->no_rpkro }}" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
            <div class="mb-1 text-left">
              <label class=" mb-2 text-sm font-medium text-gray-900 dark:text-white w-1/2 text-left">JENIS RPKRO :</label>
              <select name="jenis_rpk_ro" disabled  class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <div class="mb-1 text-left">
              ...
              <select name="lokasi_dermaga_id" disabled class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <div class="mb-1 text-left">
              ...
              <input type="datetime-local" name="waktu_rencana" disabled value="{{ @$input->waktu_rencana }}" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
            <div class="mb-1 text-left">
              <label class=" mb-2 text-sm font-medium text-gray-900 dark:text-white w-1/2 text-left">KETERANGAN :</label>
              <textarea name="keterangan" cols="30" disabled rows="3" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ @$input->keterangan }}</textarea>
            </div>
          </div>
          ...
          <div class="w-[900px] my-2 grid grid-cols-3 gap-3">
            ...
            <div class="mb-1 text-left">
              ...
              <input type="text" name="no_ppkb" value="{{ @$input->no_ppkb }}" disabled class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
            <div class="mb-1 text-left">
              <label class=" mb-2 text-sm font-medium text-gray-900 dark:text-white w-1/2 text-left">KOMODITI :</label>
              <input type="text" name="komoditi" value="{{ @$data->komoditi }}" disabled class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
            <div class="mb-1 text-left">
