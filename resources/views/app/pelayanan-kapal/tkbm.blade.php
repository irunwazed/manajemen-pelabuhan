    ...
    <center>
      ...
      <div class="w-[700px] my-2 grid grid-cols-3 gap-3">
        ...
        <div class="mb-1 text-left">
          <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white w-1/2 text-left">TANGGA: PERMOHONAN TKBM :</label>
        ...
        <div class="mb-1 text-left">
          <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white w-1/2 text-left">JLH SHIFT TOTAL :</label>
          <input type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>
        <div class="mb-1 text-left">
          <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white w-1/2 text-left">NO SPK TKBM :</label>
          <input type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>
        <div class="mb-1 text-left">
        ...
        <div class="mb-1 text-left">
          <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white w-1/2 text-left">JLH BURUH/GROUP :</label>
          <input type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>
        <div class="mb-1 text-left">
          <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white w-1/2 text-left">SIFAT KERJA :</label>
          <input type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>
        <div>
