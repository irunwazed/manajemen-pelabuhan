...
<div class="">
  ...
  <div class="text-2xl ">Pelayanan Kapal / Kepelautan</div>
  <hr class="border-b-2 border-black border-solid">

  <div class="text-center mb-3 mt-5">
    <h2 class="text-2xl font-bold mt-10 mb-7">DAFTAR CREW KAPAL KEBERANGKATAN</h2>
    <center>
    ...
    <tbody>
      <tr>
        ...
        <td class="py-3">
          ...
          <a href="kepelautan-verifikasi" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Verifikasi</a>
        </td>
      </tr>
    </tbody>
  </table>
