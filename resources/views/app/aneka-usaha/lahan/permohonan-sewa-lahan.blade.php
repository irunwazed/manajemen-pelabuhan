...
<div class="">
    ...
    <div class="grid grid-cols-4 gap-2 pt-16">
        <div class="text-start w-full">
            ...
            <div>
                <input type="text" value="" class="mt-1 block w-full px-3 py-2 bg-white border border-slate-800 rounded-md text-sm shadow-sm placeholder-slate-400">
            </div>
        </div>
        <div class="text-start w-full">
            <div>
    ...
    <div class="text-end pt-5">
        <a href="{{ url('admin/aneka-usaha/lahan/create-permohonan-sewa-lahan') }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-10 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Buat
            Data</a>
    </div>
                    ...
                    <tr class="border-solid border-1 border-slate-800 bg-slate-200 hover:bg-slate-300">
                        ...
                        <td>
                            <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-10 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                                <a href='{{ url("admin/aneka-usaha/lahan/detail-permohonan-sewa-lahan/$dat->au_lahan_id") }}'>View</a></button>
                            <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-10 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                                <a href="{{ url('admin/aneka-usaha/lahan/edit-permohonan-sewa-lahan') }}">Edit<a />
                            </button>
                            <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-10 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"><a href='{{ url("admin/aneka-usaha/lahan/pranota-permohonan-sewa-lahan/$dat->au_lahan_id") }}'>Pranota<a /></button>
                            <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-10 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"><a href="{{ url('admin/aneka-usaha/lahan/nota-4g') }}"> Nota4G<a /></button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
