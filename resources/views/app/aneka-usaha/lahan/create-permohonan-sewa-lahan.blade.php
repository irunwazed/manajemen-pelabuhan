...
<div class="">
    ...
    <form action="{{route('lahanCreate', $user)}}" method="post">
            ...
            <div class="border-2">
                <table class="w-full text-center">
                    ...
                    <tr class="text-start mb-4">
                        ...
                        <td>:</td>
                        <td class="py-1">
                            <input type="text" name="norek" id="norek" class="mt-1 block w-full px-3 py-2 bg-gray-200 border border-slate-800 rounded-md text-sm shadow-sm placeholder-slate-400">
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div class="text-center pt-16 mt-16 pb-9">
            ...
            <a href="{{url('admin/aneka-usaha/lahan/permohonan-sewa-lahan')}}" class="text-base text-gray-900 bg-white border border-gray-300 px-6 py-2.5 rounded hover:opacity-80">Batal</a>
        </div>
    </form>
