...
<div class="">
    ...
    <div class="text-end pt-5">
        <a href="{{url('admin/aneka-usaha/create-permohonan-sewa-lahan')}}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-10 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Buat Data</a>
    </div>
                ...
                <tbody>
                    <tr class="border-solid border-2 border-slate-800 hover:bg-slate-300">
                        ...
                        <td>
                            ...
                            <!--<a href="{{url('admin/aneka-usaha/edit-permohonan-sewa-lahan')}}" class="btn bg-blue-600 text-blue-100 hover:bg-purple-600">
                            <a href="{{url('admin/aneka-usaha/nota-4g')}}" class="btn bg-blue-600 text-blue-100 hover:bg-purple-600">Pranota</a>
