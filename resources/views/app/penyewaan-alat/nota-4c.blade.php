                ...
                <table class="mt-5 w-full border-solid border-2 border-slate-800">
                    ...
                    <tr class="border-solid border-2 border-slate-800 hover:bg-slate-300">
                        ...
                        <td>
                            ...
                            <a href="{{url('admin/penyewaan-alat/create-nota-4c')}}" class="font-semibold py-1 px-6 rounded-md hover:opacity-80 bg-blue-600 text-blue-100 hover:bg-purple-600">Create Nota 4C</a>
                        </td>
                    </tr>
                    </tbody>
                </table>
