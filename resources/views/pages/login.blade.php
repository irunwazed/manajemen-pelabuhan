                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute inset-y-0 right-0 pr-10 flex items-center text-sm leading-5">
                            ...
                            <svg class="h-6 text-gray-700 absolute" fill="none" onClick="passwordHide(this)" id="svgShowPass"
                            ...
                            <svg class="h-6 text-gray-700 invisible absolute" fill="none" id="svgHidePass" onClick="passwordHide(this)"
                            xmlns="http://www.w3.org/2000/svg"
                            viewbox="0 0 640 512">
                            <path fill="currentColor"
