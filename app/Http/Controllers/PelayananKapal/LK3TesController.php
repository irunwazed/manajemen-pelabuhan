...
class LK3TesController extends Controller
{
  ...
  public function list(Request $request, $user)
  {
    ...
    $query = DB::table('t_pelayanan_kapal')
      ...
      ->where("t_pelayanan_kapal.flag_berangkat", "2");
    ...
    return view('app.pelayanan-kapal.lk3-tes.list', $result);
  }
  ...
  //   return view('app.pelayanan-kapal.lk3.detail', $result);
  // }
